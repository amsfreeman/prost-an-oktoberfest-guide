...
if __name__ == '__main__':
    with app.app_context():
        ...
        t10 = Tent(name = "Ochsenbraterei", capacity = "7550", first_year = "1881", beer_sold = "Spaten", image = "https://oktoberfest-guide.com/site/assets/files/2142/ochsenbraterei-neubau-2017-front-tag.1920x0.webp", details = "Thanks to the famous oxen and traditional music, in the afternoon, the tent of the Spaten brewery is one of the most popular. The contemporary evenings are rather slow.")
