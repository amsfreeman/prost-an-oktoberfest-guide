    ...
    return(
        <div className="layout-container">
            ...
            <div className='center-section'>
                ...
                <h5 className='about-1'>Oktoberfest is a beer festival that happens yearly in Munich, Germany. Oktoberfest's first year was 1810, when it originated as a wedding festival for Crown Prince Ludwig and Princess Therese of Saxe-Hildburghausen[1]. The original dates were in October, but as mentioned on the official Oktoberfest website, it was later moved to earlier in September, as least partially due to the better weather in September[2].</h5>
                <h5 className='about-2'>Oktoberfest has happened every year since 1810, but has been cancelled roughly 26 times, including 1813, 1854, 1866, 1870, 1873, 1914-1920, 1923-1924, 1939-1948, and 2020-2021.</h5>
                <h5 className='about-3'>Oktoberfest is marked by its 14 large tents, which you can see on the Tents page. In addition, Oktoberfest has a series of small tents, attractions, and amusement park style rides.</h5>
                <h5 className='about-4'>In addition, since 2010 there has been Oide Wiesen, a section of Oktoberfest designed to look more traditional. There is a 4 euro entrace fee for people older than 14, but after 9pm, it is free[4]. Once inside there are cheaper traditional rides, and a few large tents.</h5>
                <h5 className='about-5'>Whether it's your first time at Oktoberfest or you are a long time visitor, feel free to look around and leave a visit!</h5>
                <h5 className='sources-header'>Sources:</h5>
